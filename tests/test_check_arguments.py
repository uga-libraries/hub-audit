...
class MyTestCase(unittest.TestCase):
    ...
    def test_both_correct(self):
        ...
        args = ['hub_audit.py', os.path.join('inventories', 'Digital Production Hub Inventory.xlsx'), 'test_shares.csv']
    ...
    def test_both_invalid(self):
        ...
        args = ['hub_audit.py', os.path.join('error', 'Digital Production Hub Inventory.xlsx'), 'error_shares.csv']
        result = check_arguments(args)
    ...
    def test_inventory_invalid(self):
        ...
        args = ['hub_audit.py', os.path.join('error', 'Digital Production Hub Inventory.xlsx'), 'test_shares.csv']
        result = check_arguments(args)
