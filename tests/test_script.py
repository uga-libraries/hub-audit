...
class MyTestCase(unittest.TestCase):
    ...
    def test_correct(self):
        ...
        expected = [['Share', 'Folder', 'Use', 'Responsible', 'Review_Date', 'Notes', 'Deleted_Date', 'Audit_Dates', 'Audit_Inventory', 'Audit_Required'],
                    ['A', 'Test Worksheet.xlsx', 'Working Files', 'Alex', '2024-01-01 00:00:00', 'nan', 'nan', 'Expired', 'Correct', 'Correct'],
                    ['B', 'B', 'nan', 'nan', 'nan', 'nan', 'nan', 'Review', 'Correct', 'Missing'],
                    ['C', 'C1', 'Backlog', 'Chris', '2124-03-18 00:00:00', 'nan', 'nan', 'Correct', 'Correct', 'Correct'],
                    ['C', 'C2', 'Backlog', 'Chris', '2124-03-18 00:00:00', 'nan', 'nan', 'Correct', 'Correct', 'Correct'],
                    ['C', 'C3', 'Backlog', 'Chris', '2124-03-18 00:00:00', 'nan', 'nan', 'Correct', 'Not in share', 'Correct'],
                    ['C', 'C4', 'Backlog', 'Chris', '2124-03-18 00:00:00', 'nan', 'nan', 'Correct', 'Not in share', 'Correct'],
                    ['C', 'Document.txt', 'Working Files', 'Camila', 'permanent', 'Documentation', 'nan', 'Correct', 'Correct', 'Correct'],
                    ['Extra', 'E_1', 'Backlog', 'Erik', '2125-01-31 00:00:00', 'nan', 'nan', 'Correct', 'Correct', 'Correct'],
                    ['Extra', 'E_2', 'Working Files', 'Erin', '2125-01-31 00:00:00', 'nan', 'nan', 'Correct', 'Correct', 'Correct'],
                    ['Extra', 'E_3', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'Not in inventory', 'nan'],
                    ['Extra', 'Text.txt', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'Not in inventory', 'nan'],
                    ['Second_Level', 'S_1', 'Backlog', 'Sam', '2125-04-01 00:00:00', 'nan', 'nan', 'Correct', 'Correct', 'Correct'],
                    ['Second_Level', 'S_2\\S_2a', 'Backlog', 'Sam', '2125-04-01 00:00:00', 'nan', 'nan', 'Correct', 'Correct', 'Correct'],
