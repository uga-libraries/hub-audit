...
class MyTestCase(unittest.TestCase):
    ...
    def test_complete(self):
        ...
        rows = [['Share', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder2', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder3', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN]]
        ...
        expected = [self.columns,
                    ['Share', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan'],
                    ['Share', 'Folder2', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan'],
                    ['Share', 'Folder3', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan']]
    ...
    def test_missing_combination(self):
        ...
        # Make a dataframe with Hub inventory data and run the function being tested.
        rows = [[NaN, NaN, 'Medium Priority', NaN, 'Permanent', NaN, NaN, NaN],
                [NaN, NaN, NaN, NaN, NaN, 'Note', NaN, NaN],
                ['Share', 'Folder3', NaN, 'Bill', NaN, NaN, NaN, NaN]]
        inventory_df = check_required(DataFrame(rows, columns=self.columns))

        # Tests if the resulting dataframe has the expected data.
        result = df_to_list(inventory_df)
        expected = [self.columns,
                    ['nan', 'nan', 'Medium Priority', 'nan', 'Permanent', 'nan', 'nan', 'Missing required data'],
                    ['nan', 'nan', 'nan', 'nan', 'nan', 'Note', 'nan', 'Missing required data'],
                    ['Share', 'Folder3', 'nan', 'Bill', 'nan', 'nan', 'nan', 'Missing required data']]
    ...
    def test_missing_date(self):
        ...
        # Make a dataframe with Hub inventory data and run the function being tested.
        rows = [['Share', 'Folder1', 'Medium Priority', 'Bill', NaN, NaN, NaN, NaN],
                ['Share', 'Folder2', 'Medium Priority', 'Bill', NaN, NaN, NaN, NaN],
                ['Share', 'Folder3', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN]]
        inventory_df = check_required(DataFrame(rows, columns=self.columns))
        ...
        result = df_to_list(inventory_df)
        expected = [self.columns,
                    ['Share', 'Folder1', 'Medium Priority', 'Bill', 'nan', 'nan', 'nan', 'Missing required data'],
                    ['Share', 'Folder2', 'Medium Priority', 'Bill', 'nan', 'nan', 'nan', 'Missing required data'],
                    ['Share', 'Folder3', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan']]
    ...
    def test_missing_folder(self):
        ...
        # Make a dataframe with Hub inventory data and run the function being tested.
        rows = [['Share', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', NaN, 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', NaN, 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN]]
        inventory_df = check_required(DataFrame(rows, columns=self.columns))
        ...
        expected = [self.columns,
                    ['Share', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan'],
                    ['Share', 'nan', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'Missing required data'],
                    ['Share', 'nan', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'Missing required data']]
    ...
    def test_missing_person(self):
        ...
        # Make a dataframe with Hub inventory data and run the function being tested.
        rows = [['Share', 'Folder1', 'Medium Priority', NaN, 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder2', 'Medium Priority', NaN, 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder3', 'Medium Priority', NaN, 'Permanent', NaN, NaN, NaN]]
        inventory_df = check_required(DataFrame(rows, columns=self.columns))

        # Tests if the resulting dataframe has the expected data.
        result = df_to_list(inventory_df)
        expected = [self.columns,
                    ['Share', 'Folder1', 'Medium Priority', 'nan', 'Permanent', 'nan', 'nan', 'Missing required data'],
                    ['Share', 'Folder2', 'Medium Priority', 'nan', 'Permanent', 'nan', 'nan', 'Missing required data'],
                    ['Share', 'Folder3', 'Medium Priority', 'nan', 'Permanent', 'nan', 'nan', 'Missing required data']]
    ...
    def test_missing_share(self):
        ...
        # Make a dataframe with Hub inventory data and run the function being tested.
        rows = [[NaN, 'Folder1', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder2', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
        ...
        result = df_to_list(inventory_df)
        expected = [self.columns,
                    ['nan', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'Missing required data'],
                    ['Share', 'Folder2', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan'],
                    ['nan', 'Folder3', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'Missing required data']]
    ...
    def test_missing_use(self):
        ...
        rows = [['Share', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder2', 'Medium Priority', 'Bill', 'Permanent', NaN, NaN, NaN],
                ['Share', 'Folder3', NaN, 'Bill', 'Permanent', NaN, NaN, NaN]]
        inventory_df = check_required(DataFrame(rows, columns=self.columns))
        ...
        expected = [self.columns,
                    ['Share', 'Folder1', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan'],
                    ['Share', 'Folder2', 'Medium Priority', 'Bill', 'Permanent', 'nan', 'nan', 'nan'],
                    ['Share', 'Folder3', 'nan', 'Bill', 'Permanent', 'nan', 'nan', 'Missing required data']]
